...
namespace UWPShop.Server.Services
{
    public class PushNotificationService
    {
        ...
        {
            string toastTitle = "UWPShop Event";
            // TODO: Replace with final Azure WebSite URL
            string baseImage = "http://localhost:58032/StoreFrontImage.png";
